        ...
        <div className="">
          <div className="sm:flex justify-between gap-3">
            <div className="mb-1 w-fit">
              ...
              <div className="font-semibold text-gray-600 underline text-base sm:text-base w-fit underline-offset-2 cursor-pointer"><a href="https://himalkom-ipb.com">Secretary of Research and Technology Department</a></div>
            </div>
