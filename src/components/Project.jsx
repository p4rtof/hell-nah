            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ">
                ...
                <div className="container text-left border border-gray-300 px-2 py-1 rounded-lg w-full hover:bg-zinc-50 hover:drop-shadow-xl hover:cursor-pointer transition-all md:w-full pl-3 ">
                    ...
                    <div className="container flex mt-2 mb-1">
                        ...
                        <div className="bg-black text-white px-1 pr-2 py-1 rounded-md m-1 font-semibold cursor-pointertext-xs flex text-sm h-fit gap-1 items-center"><a href="https://github.com/p4rtof" target="_blank" className="text-white gap-1 transition flex items-center ">
